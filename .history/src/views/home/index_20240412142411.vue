  ...
  <div class="container">
    ...
    <div class="hot-product-container">
      ...
      <div class="product-container">
        <div
          v-for="(hotItem, HIndex) in hotProduct"
          class="hot-product-item"
          :class="{ 'hot-item-hover': hotItem.isHover }"
      ...
      <div class="about-us-detail-container">
        <div class="about-us-img-container">
          <div class="about-us-intro-img-container">
            <img
              src="https://tentech.oss-cn-shenzhen.aliyuncs.com/images/about-us/about-us-company-01.jpg"
            />
          </div>
        </div>
        ...
        <div class="about-us-intro-container">
          ...
          <div
            class="intro-detail-button"
            @click="
              router.push({
                path: '/aboutus',
                query: { seriesId: 'companyIntro' },
              })
            "
          >
            <p>{{ t("common.detail") }}</p>
    ...
    <div class="featured-product-container">
      <div class="featured-product-detail-container">
        ...
        <div class="product-list-swiper-container">
          <product-list-swiper
            class="full-width"
            :product-swiper-list="featuredProduct"
          ></product-list-swiper>
          <product-list-swiper-min
            class="min-width-container"
            :product-swiper-list="featuredProduct"
          ></product-list-swiper-min>
        </div>
      </div>
    ...
    <div class="hot-sell-products-container">
      <div class="featured-product-detail-container">
        ...
        <div class="product-list-swiper-container case-show-container">
          <div
            class="case-show-item"
            :class="showCase.isSelected ? 'showCaseSelected' : ''"
            v-for="(showCase, index) in caseList"
            :style="{
              'background-image': `url(\' ${showCase.imgUrl} \')`,
          ...
          >
            ...
            <router-link
              :to="showCase.path"
              class="show-case-desc"
              :class="{ 'show-desc-select': showCase.isSelected }"
            >
      ...
      <div class="news-container">
        ...
        <div class="news-item-container">
          ...
          <router-link
            ...
            class="news-item-show news-item-hover"
          ...
          >
            ...
            <div class="news-desc">
              ...
              <div class="gotoNewDetail">
                <img
                  src="https://tentech.oss-cn-shenzhen.aliyuncs.com/images/news/new-arrow.png"
                />
              </div>
            </div>
          </router-link>
    ...
    <div class="tentech-intro-container"></div>
  </div>
</template>
...
const pageSEOInfo = ref({
  title:
    "LED显示屏 ,Led显示屏箱体，led显示屏工厂、led拼接屏，led室外屏，led室内屏，led显示屏租赁、led全彩显示屏、led显示屏压铸箱体，租赁led显示屏,广告条屏 ，显示屏解决方案",
  description:
    "深圳市全德视讯有限公司成立于2015年，是一家创新型专注于生产LED 显示屏的公司，拥有自己的实力工厂，我司通过提供可靠的LED显示屏产品及LED显示屏配件，24小时咨询热线: 0755 27192472",
  keywords:
    "led显示屏 ,led显示屏箱体，led显示屏工厂、显示屏生产厂家、led拼接屏，led户外显示屏，led室内屏，led显示屏租赁、led全彩显示屏、led显示屏压铸箱体，led模组、租赁led显示屏",
});
